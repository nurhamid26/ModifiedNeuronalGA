...
public class GASetting : MonoBehaviour
{
    [Header("References")]
    public USVController controller;
    ...
    public int bestAgent = 10;
    public int worstAgent = 4;
    ...
    private void CreatePopulation()
    {
        ...
        FillWithRandomValues(population, 0);
    ...
    //End Function
    public void End (float fitness, NeuralNetwork network)
    {
    ...
    private void RePopulate()
    {
        ...
        FillWithRandomValues(newPopulation, naturallySelected);
